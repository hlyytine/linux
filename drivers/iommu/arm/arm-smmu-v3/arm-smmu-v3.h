...
static inline bool queue_consumed(struct arm_smmu_ll_queue *q, u32 prod)
{
...
static inline void queue_poll_init(struct arm_smmu_device *smmu,
...
static inline int queue_poll(struct arm_smmu_queue_poll *qp)
{
